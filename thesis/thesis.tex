...
I must thank Michaela Wawra, MSc, and Dr. Alexander Pfeiffer for their guidance and support in writing this thesis.
...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        This topic entails discussing the role of machine learning in human resource management and how it can complement human decision-making.
...
\begin{itemize} \label{job_requirement_types}
    ...
    This requirement type includes personality traits the employer seeks to achieve a high person-environment fit and a high person-job fit, such as attention to detail, reliability, creativity, or general intelligence.
...
The job requirements extracted in the previous step are matched against each applicant's \acs{CV} that is also already supplied as pure text because it already had gone through the preprocessing.
...
Data was collected by recording and transcribing the two meetings used to obtain qualitative data.
