...
\hypersetup{
    ...
    pdfkeywords     = {Machine Learning, \acs{HR}, Human Resources, AI, LLM} % The document's keywords in the document properties (optional).
}
...
\begin{enumerate}
    ...
    \item \textbf{Legal Considerations}
    \begin{itemize}
        \item What legal challenges do you foresee in implementing AI in \acs{HR} processes, particularly concerning data security and privacy?
    ...
    \begin{itemize}
        ...
        \item How should these technologies integrate with existing \acs{HR} systems and file types?
    ...
    \item \textbf{Previous Experiences with AI-assisted Technologies in Human Resources}
    \begin{itemize}
        \item What has been your experience with AI-assisted technologies in \acs{HR} to date?
        ...
        \item How have these technologies been integrated into the \acs{HR} pipeline in your experience?
    \end{itemize}
    \item \textbf{Costs}
    \begin{itemize}
