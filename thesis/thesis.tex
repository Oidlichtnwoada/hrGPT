...
That means if an \acs{LLM} scores higher than the human expert-level performance, it can perform similarly to human domain experts.
...
The presented methods all have the common deficiency of either manually creating a keyword dictionary or having access to a large dataset of applicant \acs{CV}s and associated job descriptions with past recruitment decisions to train the model.
