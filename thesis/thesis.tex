...
Furthermore, also the English text contents of the \textit{CSV} and \textit{JSON} output files can be translated back to the non-English language of the input \textit{PDF} documents.
