...
The \textit{Gemini} model family suffered from similar issues as the \textit{OpenAI} models, it does not even support to seed the internally used random number generator.
