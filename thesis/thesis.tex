...
This assessment also received legal support and was merged into the employee selection procedure, this fit measure can be operationalized in the following ways \cite[183-184]{po_and_pj_fit_literature_review}:
\begin{enumerate}
