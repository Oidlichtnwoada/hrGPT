...
Compared to the table, this \textit{JSON} file also contains information on the individual requirements that were matched, including their score and textual explanations.
