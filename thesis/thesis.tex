...
As a methodology for the preparation of this Master's thesis and to substantiate the statements a literature research is carried out firstly.
Only qualitative literature, publications, papers and scientific articles in journals, as well as books from various online libraries were used as information sources. 
Also some internet sources have been used for the purpose of linking the reader directly to the respective source without having to rely on a search engine.
This literature review should primarily serve to provide a theoretical basis whether the use of \acs{LLM}s may be a good fit for the screening task and how other researchers have approached the person-environment fit quantization problem from a technical perspective.
Furthermore, it should also provide theory on person-environment fit in general and it should also list considerations on and chances of using \acs{AI}-assisted tools in the human resources domain.
Moreover, a guideline interview in a group discussion setting is used to collect qualitative information from the five participating human experts recruiters on their considerations, expectations and past experiences with \acs{AI}-assisted tools.
In this empirical part, these experts will also be interviewed on the results of the implemented proposed model and all participating experts have at least five years of professional experience in this domain.
...
This should provide an answer to a part of the research question that covers the aspect of how and in what way an \acs{LLM}-based model would affect the screening process.
This entails the expected baseline performance for the model is as well as considerations on the model usage.

All quantitative information regarding the proposed and implemented \acs{LLM}-based model is obtained from an experiment that is conducted especially for this thesis for reasons of trustworthiness, validity and quality.
...
This statistical analysis should provide an answer to the research question and especially the two quantitative subordinate research questions.
...
A qualitative content analysis with inductive category formation according to \textit{Mayring} \parencite{mayring} of the transcribed group discussion will be carried out to work with a proven and repeatable methodology and gain valuable insights.
