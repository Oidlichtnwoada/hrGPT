...
\csv{taken_time}{Tracked Taken Time in minutes by Human Recruiters}

\chapter{Analysis} \label{analysis}

\section{Analysis of a Model Sample Output} \label{analysis_sample_output}
...
\csv{sample_job_match_result}{Sample Job Match Result Overview}
...
\csv{taken_time_model}{Tracked Taken Time in minutes by Model}
...
\section{Model Sample Match Results}
