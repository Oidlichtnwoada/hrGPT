...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        The operation should be probably reliable and different resume formats and layouts should be supported while keeping the ability to match job requirements with various qualifications and experiences in different industry fields.
