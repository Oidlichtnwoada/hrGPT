...
These ranking and categorization results are then typed into an online form in order to sanity check the passed input data before the human experts are allowed to submit it.
