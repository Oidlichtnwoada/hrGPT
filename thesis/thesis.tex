...
The accuracy of the designed screening model will be determined by comparing the ranking of the model's output to the mean ranking of human experts against a test set. Therefore, it is a quantitative research design. The test set to benchmark the built model will contain ten job descriptions from various industries with ten applicant resumes per job description. The ten applicant resumes for each of the ten job descriptions will be ranked from each of the ten human-expert recruiters from best (1\textsuperscript{st} place) to worst (10\textsuperscript{th} place) within their associated job description. That means there will be ten rankings for each of the job description as every human-expert recruiter ranks all the resumes for each job description. 
