...
\begin{itemize}
    ...
    Furthermore, it was proposed that job requirement type weightings be finer-grained by introducing subtypes for each type. This would allow for a more precise model configuration, but it needs a predefined or user-defined ontology for each type to define the relations.
    \item \textbf{Implicit Job Requirements}\\
