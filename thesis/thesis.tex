...
\hypersetup{
    ...
    pdfkeywords     = {Machine Learning, \acs{HR}, Human Resources, \acs{AI}, LLM, Screening, Applicant Screening, Applicant Ranking, Applicant Filtering, Explainability, Interpretability} % The document's keywords in the document properties (optional).
}
