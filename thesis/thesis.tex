...
\lstinputlisting[language=TypeScript,label=lst:code_usage,caption=Example usage of the programmed model,captionpos=b]{../libs/utils-lib/src/lib/wrapper/wrapper.spec.ts}
