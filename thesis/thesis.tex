...
The prettification was done by sending the extracted text to an \gls{LLM}, which was asked to group relevant text parts in a paragraph and to improve the overall formatting of the text without changing the text contents.
...
The model correctly separates the two language requirements for the job description and assign the correct requirement type. The scoring of the requirements also seem to be appropriate when analyzing the applicant documents. That overview should have given the reader a good overview on what output files and output information the human recruiter can expect from the proposed model.
