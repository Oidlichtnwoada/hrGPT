...
\section{Analysis of a Model Sample Output}
...
During the closure meeting, it was evident that there was a significant discrepancy between the model's and human recruiters' categorization and ranking of applicants, primarily due to inconsistencies among the recruiters themselves. Three out of five recruiters highlighted difficulties in categorizing and ranking without predefined criteria and struggled with job descriptions lacking specific company names or featuring lesser-known companies. They also missed direct interactions with candidates, which are crucial for gathering additional information and typically do not rank applicants at the initial screening stage. Additionally, the lack of domain knowledge for specific roles like a "Green Hydrogen Piping Engineer" was a challenge. One recruiter noted that differences might stem from varying job requirement weightings used by individuals and the model, suggesting that the model could better assess transferable skills due to its underlying ontology learning. The same recruiter proposed incorporating seniority as a knockout criterion in the model, mirroring human practices. Another recruiter emphasized the importance of the context in which skills are used, such as programming at a major company versus a startup, and highlighted the significance of a fading factor for scoring past abilities. The discussion also touched on the potential of the tool to support unbiased applicant ranking and categorization, as it maintains consistent weighting across applicants. No biases or outliers were reported in the model's output, though one recruiter mentioned that humans might handle implicit \acs{CV} information better through personal experience or additional inquiries.
