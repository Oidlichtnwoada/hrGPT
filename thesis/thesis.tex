...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        Four of five recruiters (\textit{E1},\textit{E2},\textit{E3},\textit{E5}) agreed that customization of \acs{AI}-assisted recruitment technologies is important regardless of industry or company culture. Only \textit{E4} said that customization is unimportant when using machine learning tools in the human resources pipeline.
