...
\section{Sample Screening Documents}
...
Information that is included in this \acs{CV} structure:
\begin{itemize}
    \item Name
    \item Summary
...
The score from $0$ to $100$ from the model output should measure the person-environment fit between the applicant and the job description \parencite[1]{po_and_pj_fit_literature_review}.
