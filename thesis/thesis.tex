...
The accuracy of the model will be measured by comparing the model's applicant ranking output to human-expert rankings. This procedure is described in detail in \ref{quantitative_research_design}.
...
\begin{enumerate}
    ...
    The comparison of the categorizations of the model against the mean or individual categorizations of the human experts will be done using TODO. 
    The mean categorizations and the summarized metrics will be computed with an arithmetic mean.
\end{enumerate}

\subsection{Rank-Biased Overlap}
Rank-biased overlap was used in \cite{rank_biased_overlap} to compare the search results of various search engines.
